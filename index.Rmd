...
**Estas cifras permiten entender lo difícil que es prestar un servicio esencial con esta estructura demográfica.**
...
```{r, echo = FALSE, eval = TRUE, fig.asp = 2/2, out.width = "98%", fig.align = "center"}
#knitr::include_graphics("./img/27_.jpg")
```
...
- La población con peores condiciones de accesibilidad tiene características muy específica —es población mayor, que reside en municipios de tamaño muy reducido, normalmente de montaña y con malas comunicaciones—
...
- El principio de equidad territorial, así como la obligatoriedad por parte de las administraciones públicas de prestar los servicios públicos de sanidad y educación, requiere de atenciones correctoras para la población con peor acceso.
